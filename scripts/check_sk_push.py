...
# OPENSSL_sk_push at 0x100484fe0
off = 0x100484fe0 - text_base
print('=== OPENSSL_sk_push ===')
for i, ins in enumerate(md.disasm(text_data[off:off+0x100], 0x100484fe0)):
