#!/usr/bin/env python3
"""Disassemble RAND_get_rand_method."""
...
# RAND_get_rand_method at 0x100444430
off = 0x100444430 - text_base
print('=== RAND_get_rand_method ===')
for i, ins in enumerate(md.disasm(text_data[off:off+0x80], 0x100444430)):
