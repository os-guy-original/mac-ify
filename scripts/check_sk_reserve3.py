#!/usr/bin/env python3
"""Continue disassembling sk_reserve from 0x10048484b."""
...
off = 0x10048484b - text_base
print('=== sk_reserve continued ===')
for i, ins in enumerate(md.disasm(text_data[off:off+0x100], 0x10048484b)):
